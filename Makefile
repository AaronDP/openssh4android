...
piddir=/data/local/tmp/var
srcdir=.
top_srcdir=.

DESTDIR=

SSH_PROGRAM=/data/local/tmp/xbin/ssh
...
LD=/tmp/chain/bin/arm-linux-androideabi-gcc
CFLAGS= -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -I/tmp/chain/include -I/opt/ndk/platforms/android-17/arch-arm/usr/include -I./openbsd-compat -I../openbsd-compat -I/opt/bionic/libc/include  -Wall -Wpointer-arith -Wuninitialized -Wsign-compare -Wformat-security -Wsizeof-pointer-memaccess -Wno-pointer-sign -Wno-unused-result -D_FORTIFY_SOURCE=2 -fno-builtin-memset 
CPPFLAGS=-I. -I$(srcdir) -I/data/local/tmp/lib/include  -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -I/tmp/chain/include -I/opt/ndk/platforms/android-17/arch-arm/usr/include -I./openbsd-compat -I../openbsd-compat -I/opt/bionic/libc/include  $(PATHS) -DHAVE_CONFIG_H
LIBS=-lcrypto -lz 
K5LIBS=
GSSLIBS=
SSHLIBS=
...
LDFLAGS=-L. -Lopenbsd-compat/ -L/data/local/tmp/lib -march=armv7-a -lc -ldl -nostartfiles  -L/opt/ndk/platforms/android-17/arch-arm/usr/lib -L/tmp/chain/lib  
EXEEXT=
...
PATHSUBS	= \
	...
	-e 's|/usr/bin:/bin:/usr/sbin:/sbin|/data/local/tmp/xbin:/sbin:/vendor/bin:/system/sbin:/system/bin:/system/xbin|g'
