...
/* Define if you systems inet_ntoa is busted (e.g. Irix gcc issue) */
...
/* Define if you dont want to use lastlog */
/* #undef DISABLE_LASTLOG */

/* Define if you dont want to use your system's login() call */
#define DISABLE_LOGIN 1

/* Define if you dont want to use pututline() etc. to write [uw]tmp */
#define DISABLE_PUTUTLINE 1

/* Define if you dont want to use pututxline() etc. to write [uw]tmpx */
#define DISABLE_PUTUTXLINE 1

/* Define if you want to disable shadow passwords */
#define DISABLE_SHADOW 1

/* Define if you dont want to use utmp */
#define DISABLE_UTMP 1

/* Define if you dont want to use utmpx */
#define DISABLE_UTMPX 1

/* Define if you dont want to use wtmp */
#define DISABLE_WTMP 1

/* Define if you dont want to use wtmpx */
...
/* Define to whatever link() returns for "not supported" if it doesnt return
   EOPNOTSUPP. */
...
/* If your header files dont define LOGIN_PROGRAM, then use this (detected)
...
/* Define if you dont want to use lastlog in session.c */
/* #undef NO_SSH_LASTLOG */

/* Define to disable UID restoration test */
/* #undef NO_UID_RESTORATION_TEST */

/* Define if X11 doesnt support AF_UNIX sockets on that system */
...
#define PRNGD_SOCKET "/dev/urandom"
...
/* Define if pam_chauthtok wants real uid set to the unprived user */
...
#define USER_PATH "/data/local/tmp/xbin:/sbin:/vendor/bin:/system/sbin:/system/bin:/system/xbin"
...
/* Define if you shouldnt strip 'tty' from your ttyname in [uw]tmp */
...
/* Define if your system has libcrypt */
...
#define _PATH_SSH_PIDDIR "/data/local/tmp/var"

/* Define if we dont have struct __res_state in resolv.h */
